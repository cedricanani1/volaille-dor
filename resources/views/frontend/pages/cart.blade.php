								...
								@if(Helper::getAllProductFromCart())
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											<td class="price" data-title="Price"><span>{{number_format($cart['price'],2)}} Fcfa</span></td>
					...
					<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Panier Total<span>{{number_format(Helper::totalCartPrice(),2)}} Fcfa</span></li>
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Vous Payez<span>{{number_format($total_amount,2)}}Fcfa</span></li>
										@else
											<li class="last" id="order_total_price">Vous Payez<span>{{number_format($total_amount,2)}}Fcfa</span></li>
										@endif
									</ul>

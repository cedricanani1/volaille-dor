										...
										<div class="product-des">
											...
											<div class="short">
												...
												<div class="rating-main">
													...
													<a href="#" class="total-review">({{$product_detail['getReview']->count()}}) Evaluation</a>
                                                </div>
                                                @php
														...
														<div class="row">
															<div class="col-12">
																...
																<p class="text-center p-5">
																	Vous devez <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Connexion</a> OU <a style="color:blue" href="{{route('register.form')}}">Inscription</a>
																...
																<div class="ratting-main">
																	<div class="avg-ratting">
																		...
																		<span>Sur la base de {{$product_detail->getReview->count()}} Commentaires</span>
																	</div>
                                    ...
                                    <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#modelExample" title="Quick View" href="#"><i class=" ti-eye"></i><span>Boutique rapide</span></a>

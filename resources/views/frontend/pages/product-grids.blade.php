                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="single-product">
                                            <div class="product-img">
                                                ...
                                                <div class="button-head">
                                                    <div class="product-action">
                                                        ...
                                                        <a title="Ajouter à la liste de souhaits" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>Ajouter à la liste de souhaits</span></a>
                                                    </div>
                                            ...
                                            <div class="product-content">
                                                ...
                                                <del style="padding-left:4%;">{{number_format($product->price,2)}} Fcfa</del>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                        ...
                                        <div class="quickview-content">
                                            ...
                                            <div class="quickview-ratting-review">
                                                <div class="quickview-ratting-wrap">
                                                    ...
                                                    <a href="#"> ({{$rate_count}} commentaire du client)</a>
                                                </div>
                                            ...
                                            @php
                                                $after_discount=($product->price-($product->price*$product->discount)/100);
                                            @endphp
                                            <h3><small><del class="text-muted">{{number_format($product->price,2)}} Fcfa</del></small>    {{number_format($after_discount,2)}}  Fcfa </h3>

    ...
    <div class="card-body">
        <div>
            ...
            <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <form method="post" action="{{route('file-import-stock')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <a class="btn btn-success" href="{{ route('file-export-stock') }}">exporter un model</a>
                            </div>
      ...
      <form method="post" action="{{route('stock.store')}}">
        ...
        <div class="form-group">
            ...
            <input id="inputTitle" type="text" name="stock" placeholder="Entrer titre"  value="{{old('stock')}}" class="form-control">
            @error('stock')
